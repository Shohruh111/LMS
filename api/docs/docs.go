    ...
    "paths": {
        ...
        "/lms/api/v1/excel/courses": {
            "get": {
                ...
                "summary": "Get List Courses",
                "operationId": "get_list_courses_excel",
                "responses": {
                    "200": {
                        "description": "Success Request",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.GroupCreate"
                        }
                    }
                ],
                "responses": {
        ...
        "/lms/api/v1/lesson": {
            ...
            "post": {
                ...
                "operationId": "create_lessons",
                "parameters": [
                    {
                        "description": "CreateLessonRequest",
                        "name": "Lesson",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/lms/api/v1/lesson/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateLessonRequest",
                        "name": "Lesson",
                        "in": "body",
                        "required": true,
                        "schema": {
